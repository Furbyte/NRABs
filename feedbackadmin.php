...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Feedback from Users</h2>
    ...
    echo '<tr>
                                       ...
                                       <td  ><a class="btn btn-primary" href=viewadminfeedback.php?id='.$row['feedbackid'].'>View</a></td>
                                          <td  ><a class="btn btn-success" href=replyfeedbackadmin.php?id='.$row['feedbackid'].'>Reply</a></td>
                                     </tr>';   
}
                                            ?>
