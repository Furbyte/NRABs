<?php
        ...
        if(isset($_GET['id'])){
            $id=$_GET['id'];
        $result = $sqlLink->query("SELECT * FROM booking where bookingid='$id'");  
         $fdate='';
          $ldate='';
                ...
                <div class="section__content section__content--p30">
                 ...
                 <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="fas fa-calendar-minus"></i></i>Dates : <?php echo "From $fdate : To $ldate" ;?></h3>
                                             <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>User : <?php echo $username ;?></h3>
<h3>
                                            <i class="fas fa-home"></i></i></i>Room ID : <?php echo $roomid ;?></h3>
                                             <h3>
                                    ...
                                    <div class="au-task js-list-load">
                                        <div class="au-task__title">
                                            <p>Details for Booking</p>
                                        </div>
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Lecturer needs Prjector:</a>
                                                    </h5>
                                                    <span class="time"><?php echo $proj;?></span>
                                                </div>
                                            </div>
                                            <div class="au-task__item au-task__item--warning">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Lecturer needs Mic:</a>
                                                    </h5>
                                                    <span class="time"><?php echo $mic;?></span>
                                                </div>
                                            </div>
                                            <div class="au-task__item au-task__item--primary">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Lecturer needs Echo 360:</a>
                                                    </h5>
                                                    <span class="time"><?php echo $echo;?></span>
                                                </div>
                                            </div>
                                            <div class="au-task__item au-task__item--success">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">Additional Comments:</a>
                                                    </h5>
                                    ...
                                    <a href="admindashboard.php">        <button class="au-btn au-btn-load js-load-btn">View All Bookings</button></a>
                                        </div>
                                    </div>
                                </div>
