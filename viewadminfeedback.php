<?php
 ...
 include_once('cntdb.php');
        $id=$_GET['id'];
        $result = $sqlLink->query("SELECT * FROM feedback where feedbackid='$id'");  
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="card border border-success">
                                    <div class="card-header">
                                        <strong class="card-title">Feedback From <?php echo $username; echo "   For   ";?>Room: <?php echo $roomid?></strong>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text"><?php echo $message;?>
                                        </p>
                                    </div>
                                </div>
                          <a class="btn btn-success" href="replyfeedbackadmin.php?id=<?php echo $feedbackid; ?>">Reply</a>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
